module FSharp.AWS.S3TypeProviderTests
...
type Generative2 = FSharp.AWS.S3TypeProvider.GenerativeProvider<2>
type Generative4 = FSharp.AWS.S3TypeProvider.GenerativeProvider<4>
